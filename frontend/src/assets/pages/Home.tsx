            ...
            <div className="flex flex-1 bg-zinc-100">
                ...
                <div className="flex flex-col w-full p-8">
                    ...
                    <div className="flex w-full justify-around gap-4">
                        <div className="flex w-full gap-4 bg-green-500 rounded-md p-4 mt-4">
                        ...
                        <div className="flex w-full gap-4 bg-red-500 rounded-md p-4 mt-4">
                            <div className="flex justify-between w-full p-2">
                                <div className="flex flex-col text-white gap-4">
                        ...
                        <div className="flex w-full gap-4 bg-blue-500 rounded-md p-4 mt-4">
                            <div className="flex justify-between w-full p-2">
                                <div className="flex flex-col text-white gap-4">
                        ...
                        <div className="flex w-full gap-4 bg-purple-500 rounded-md p-4 mt-4">
                            <div className="flex justify-between w-full p-2">
                                <div className="flex flex-col text-white gap-4">
